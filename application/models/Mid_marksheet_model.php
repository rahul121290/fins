...
class Mid_marksheet_model extends CI_Model{
    public function preResult($data){
        $session = $data['session'];
        $school = $data['school'];
        $exam_type = 1;//-----------1 is exam type pre
        $medium = $data['medium'];
    ...
    public function midResult($data){
        $session = $data['session'];
        $school = $data['school'];
        $exam_type = 2;//-----------1 is exam type pre
        $medium = $data['medium'];
        $class_name = $data['class'];
        $sub_group = $data['sub_group'];
        $section = $data['section'];
...
//         }
    ...
    public function midCoScholistic($data){
        $session = $data['session'];
        $school = $data['school'];
        $exam_type = 2;//-----------1 is exam type pre
        $medium = $data['medium'];
